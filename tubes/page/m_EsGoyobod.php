...
<html lang="en">
  <head>
    ...
    <title>Es Goyobod</title>
    <link rel="stylesheet" href="../css/detailminuman.css">
  </head>
  <body>
...
<section class="mb-5 mt-5 py-5 ">
  <div class="container">
    <div class="row h-100 w-100 mx-auto border p-4 shadow-sm rounded bg-white">
      <div class="col-md-12">
        <h4 class="fw-bold text-center">Es Goyobod</h4>
        <div class="row pt-3">
          <div class="col-md-6 my-auto text-center text-lg-start">
            <img src="../img/minuman/es goyobod.png" width="70%" alt="">
          </div>
