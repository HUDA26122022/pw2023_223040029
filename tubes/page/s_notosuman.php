...
<html lang="en">
  <head>
    ...
    <title>Serabi Notosuman</title>
    <link rel="stylesheet" href="../css/s_notosuman.css">
  </head>
  <body>
...
<section class="mb-5 mt-5 py-5 ">
  <div class="container">
    <div class="row h-100 w-100 mx-auto border p-4 shadow-sm rounded bg-white">
      <div class="col-md-12">
        <h4 class="fw-bold text-center">Serabi Notosuman</h4>
        <div class="row pt-3">
          <div class="col-md-6 my-auto text-center text-lg-start">
            <img src="../img/makanan/serabi notosuman.png" width="70%" alt="">
          </div>
